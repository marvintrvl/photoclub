...
urlpatterns = [
    ...
    path('submission/new/<int:challenge_id>/', views.ChallengeSubmissionCreateView.as_view(), name='photo_challenge_submission_create'),
    path('vote/<int:submission_id>/', views.vote_submission, name='photo_challenge_vote_submission'),
    path('comment/<int:submission_id>/', views.add_comment, name='photo_challenge_add_comment'),
