...
from .views import (
    ...
    add_photo, delete_photo, delete_equipment, delete_interest,
    delete_photo_genre, add_equipment, add_interest, add_photo_genre,
    manage_steckbrief, manage_categories  # Make sure to import the manage_steckbrief view
)
...
urlpatterns = [
    ...
    path('profile/manage_categories/', manage_categories, name='manage_categories'),
